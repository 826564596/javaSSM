...
<div data-options="region:'north',border:false" style="height:60px;background:#2596ea;padding:10px;">
    <div style="text-align: center;font-style: oblique; font-size: 28px;font-family: 宋体;color: white;">V课堂教师后台管理</div>
    <div style="text-align: right;font-size: small;color:#fff;">
        欢迎 <%=session.getAttribute("managerName")%> 教师 || <a style="text-decoration: none" onclick="toEditPassWord()">修改密码</a>
    </div>
</div>
